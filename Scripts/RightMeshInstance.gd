...
@export var points = [Vector3(0, 0, 0), Vector3(0, 0, -1)] 
...
@onready var audio_player = $RightController/MeshInstance3D/AudioStreamPlayer3D
...
func _process(delta):
	print("Controller Global Transform:", get_parent().global_transform.origin)
